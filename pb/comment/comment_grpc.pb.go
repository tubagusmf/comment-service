...
const (
	CommentService_FindComments_FullMethodName = "/comment.CommentService/FindComments"
)
...
func (c *commentServiceClient) FindComments(ctx context.Context, in *CommentRequest, opts ...grpc.CallOption) (*CommentList, error) {
	...
	out := new(CommentList)
	err := c.cc.Invoke(ctx, CommentService_FindComments_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CommentService_FindComments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CommentService_FindComments_FullMethodName,
	}
